...
for (let i = 0; i < 950; i++) {
  ...
  recordTileProfile({type:'p5',renderMs:1,effectsMs:2,passes:2,pixels:480000,p5Fps:30,focused:true,p5DrawP95Ms:3.5,p5CaptureP95Ms:1.2,p5ProfileActive:true});
  endFrameProfile();
}
...
assert.equal(summary.p5ProfileActive, true);
